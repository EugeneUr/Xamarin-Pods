...
namespace MacCharts
{
    ...
    interface ChartData
    {
        ...
        // -(NSArray<NSColor *> * _Nullable)getColors;
        ...
        void SetValueTextColor(NSColor color);
    ...
    interface ChartDataEntryBase
    {
        ...
        // -(instancetype _Nonnull)initWithY:(double)y icon:(NSImage * _Nullable)icon __attribute__((objc_designated_initializer));
        [Export("initWithY:icon:")]
        [DesignatedInitializer]
        IntPtr Constructor(double y, [NullAllowed] NSImage icon);

        // -(instancetype _Nonnull)initWithY:(double)y icon:(NSImage * _Nullable)icon data:(id _Nullable)data __attribute__((objc_designated_initializer));
        [Export("initWithY:icon:data:")]
        [DesignatedInitializer]
        IntPtr Constructor(double y, [NullAllowed] NSImage icon, [NullAllowed] NSObject data);
    ...
    interface ChartDataEntry
    {
        ...
        [DesignatedInitializer]
        IntPtr Constructor(double x, double y, [NullAllowed] NSImage icon);
        ...
        [DesignatedInitializer]
        IntPtr Constructor(double x, double y, [NullAllowed] NSImage icon, [NullAllowed] NSObject data);
    ...
    interface BarChartDataEntry
    {
        ...
        // -(instancetype _Nonnull)initWithX:(double)x y:(double)y icon:(NSImage * _Nullable)icon __attribute__((objc_designated_initializer));
        [Export("initWithX:y:icon:")]
        [DesignatedInitializer]
        IntPtr Constructor(double x, double y, [NullAllowed] NSImage icon);

        // -(instancetype _Nonnull)initWithX:(double)x y:(double)y icon:(NSImage * _Nullable)icon data:(id _Nullable)data __attribute__((objc_designated_initializer));
        [Export("initWithX:y:icon:data:")]
        [DesignatedInitializer]
        IntPtr Constructor(double x, double y, [NullAllowed] NSImage icon, [NullAllowed] NSObject data);
        ...
        // -(instancetype _Nonnull)initWithX:(double)x yValues:(id)yValues icon:(NSImage * _Nullable)icon data:(id _Nullable)data __attribute__((objc_designated_initializer));
        [Export("initWithX:yValues:icon:data:")]
        [DesignatedInitializer]
        IntPtr Constructor(double x, NSNumber[] yValues, [NullAllowed] NSImage icon, [NullAllowed] NSObject data);

        // -(instancetype _Nonnull)initWithX:(double)x yValues:(id)yValues icon:(NSImage * _Nullable)icon __attribute__((objc_designated_initializer));
        [Export("initWithX:yValues:icon:")]
        [DesignatedInitializer]
        IntPtr Constructor(double x, NSNumber[] yValues, [NullAllowed] NSImage icon);
    ...
    interface InterfaceChartDataSet
    {
        ...
        // @required @property(readonly, copy, nonatomic) NSArray<NSColor *> * _Nonnull valueColors;
        [Abstract]
        [Export("valueColors", ArgumentSemantic.Copy)]
        NSColor[] ValueColors { get; }

        // @required @property(readonly, copy, nonatomic) NSArray<NSColor *> * _Nonnull colors;
        [Abstract]
        [Export("colors", ArgumentSemantic.Copy)]
        NSColor[] Colors { get; set; }

        // @required -(NSColor * _Nonnull)colorAtIndex:(NSInteger)atIndex;
        [Abstract]
        [Export("colorAtIndex:")]
        NSColor ColorAtIndex(nint atIndex);
        ...
        // @required -(void)addColor:(NSColor * _Nonnull)color;
        [Abstract]
        [Export("addColor:")]
        void AddColor(NSColor color);

        // @required -(void)setColor:(NSColor * _Nonnull)color;
        [Abstract]
        [Export("setColor:")]
        ...
        // @required @property(nonatomic, strong) NSColor * _Nonnull valueTextColor;
        [Abstract]
        [Export("valueTextColor", ArgumentSemantic.Strong)]
        NSColor ValueTextColor { get; set; }

        // @required -(NSColor * _Nonnull)valueTextColorAt:(NSInteger)index;
        [Abstract]
        [Export("valueTextColorAt:")]
        NSColor ValueTextColorAt(nint index);

        // @required @property(nonatomic, strong) NSFont * _Nonnull valueFont;
        [Abstract]
        [Export("valueFont", ArgumentSemantic.Strong)]
        NSFont ValueFont { get; set; }
    ...
    {
        // @required @property(nonatomic, strong) NSColor * _Nonnull highlightColor;
        [Abstract]
        [Export("highlightColor", ArgumentSemantic.Strong)]
        NSColor HighlightColor { get; set; }
    ...
    interface InterfaceBarChartDataSet : InterfaceBarLineScatterCandleBubbleChartDataSet
    {
        ...
        // @required @property(nonatomic, strong) NSColor * _Nonnull barShadowColor;
        [Abstract]
        [Export("barShadowColor", ArgumentSemantic.Strong)]
        NSColor BarShadowColor { get; set; }
        ...
        // @required @property(nonatomic, strong) NSColor * _Nonnull barBorderColor;
        [Abstract]
        [Export("barBorderColor", ArgumentSemantic.Strong)]
        NSColor BarBorderColor { get; set; }
    ...
    interface ChartBaseDataSet : InterfaceChartDataSet
    {
        ...
        // @property(copy, nonatomic) NSArray<NSColor *> * _Nonnull colors;
        [Export("colors", ArgumentSemantic.Copy)]
        NSColor[] Colors { get; set; }

        // @property(copy, nonatomic) NSArray<NSColor *> * _Nonnull valueColors;
        [Export("valueColors", ArgumentSemantic.Copy)]
        NSColor[] ValueColors { get; set; }
        ...
        [Export("colorAtIndex:")]
        NSColor ColorAtIndex(nint index);
        ...
        // -(NSColor * _Nonnull)valueTextColorAt:(NSInteger)index;
        [Export("valueTextColorAt:")]
        NSColor ValueTextColorAt(nint index);
    ...
    interface BarChartRenderer
    {
        ...
        // -(void)drawValueWithContext:(CGContext)context value:(id)value xPos:(id)xPos yPos:(id)yPos font:(NSFont * _Nonnull)font align:(id)align color:(NSColor * _Nonnull)color;
        [Export("drawValueWithContext:value:xPos:yPos:font:align:color:")]
        void DrawValueWithContext(CGContext context, NSObject value, NSObject xPos, NSObject yPos, NSFont font, NSObject align, NSColor color);
    ...
    [BaseType(typeof(NSView), Name = "_TtC6Charts8NSUIView")]
    interface NSUIView
    {
        // -(void)touchesBegan:(NSSet<NSTouch *> * _Nonnull)touches withEvent:(NSEvent * _Nullable)event;
        [Export("touchesBegan:withEvent:")]
        void TouchesBegan(NSSet<NSTouch> touches, [NullAllowed] NSEvent @event);

        // -(void)touchesMoved:(NSSet<NSTouch *> * _Nonnull)touches withEvent:(NSEvent * _Nullable)event;
        [Export("touchesMoved:withEvent:")]
        void TouchesMoved(NSSet<NSTouch> touches, [NullAllowed] NSEvent @event);

        // -(void)touchesEnded:(NSSet<NSTouch *> * _Nonnull)touches withEvent:(NSEvent * _Nullable)event;
        [Export("touchesEnded:withEvent:")]
        void TouchesEnded(NSSet<NSTouch> touches, [NullAllowed] NSEvent @event);

        // -(void)touchesCancelled:(NSSet<NSTouch *> * _Nonnull)touches withEvent:(NSEvent * _Nullable)event;
        [Export("touchesCancelled:withEvent:")]
        void TouchesCancelled(NSSet<NSTouch> touches, [NullAllowed] NSEvent @event);

        // -(void)nsuiTouchesBegan:(NSSet<NSTouch *> * _Nonnull)touches withEvent:(NSEvent * _Nullable)event;
        [Export("nsuiTouchesBegan:withEvent:")]
        void NsuiTouchesBegan(NSSet<NSTouch> touches, [NullAllowed] NSEvent @event);

        // -(void)nsuiTouchesMoved:(NSSet<NSTouch *> * _Nonnull)touches withEvent:(NSEvent * _Nullable)event;
        [Export("nsuiTouchesMoved:withEvent:")]
        void NsuiTouchesMoved(NSSet<NSTouch> touches, [NullAllowed] NSEvent @event);

        // -(void)nsuiTouchesEnded:(NSSet<NSTouch *> * _Nonnull)touches withEvent:(NSEvent * _Nullable)event;
        [Export("nsuiTouchesEnded:withEvent:")]
        void NsuiTouchesEnded(NSSet<NSTouch> touches, [NullAllowed] NSEvent @event);

        // -(void)nsuiTouchesCancelled:(NSSet<NSTouch *> * _Nullable)touches withEvent:(NSEvent * _Nullable)event;
        [Export("nsuiTouchesCancelled:withEvent:")]
        void NsuiTouchesCancelled([NullAllowed] NSSet<NSTouch> touches, [NullAllowed] NSEvent @event);
    ...
    interface ChartViewBase : IChartDataProvider, IChartAnimatorDelegate
    {
        ...
        // -(NSImage * _Nullable)getChartImageWithTransparent:(BOOL)transparent;
        [Export("getChartImageWithTransparent:")]
        [return: NullAllowed]
        NSImage GetChartImageWithTransparent(bool transparent);
    ...
    // @interface BarLineChartViewBase : ChartViewBase <BarLineScatterCandleBubbleChartDataProvider, NSClickGestureRecognizerDelegate>
    [BaseType(typeof(ChartViewBase), Name = "_TtC6Charts20BarLineChartViewBase")]
    interface BarLineChartViewBase : BarLineScatterCandleBubbleChartDataProvider, INSGestureRecognizerDelegate
    {
        // @property(nonatomic, strong) NSColor * _Nonnull gridBackgroundColor;
        [Export("gridBackgroundColor", ArgumentSemantic.Strong)]
        NSColor GridBackgroundColor { get; set; }
        ...
        // -(BOOL)gestureRecognizerShouldBegin:(NSClickGestureRecognizer * _Nonnull)gestureRecognizer;
        [Export("gestureRecognizerShouldBegin:")]
        bool GestureRecognizerShouldBegin(NSClickGestureRecognizer gestureRecognizer);

        // -(BOOL)gestureRecognizer:(NSClickGestureRecognizer * _Nonnull)gestureRecognizer shouldRecognizeSimultaneouslyWithGestureRecognizer:(NSClickGestureRecognizer * _Nonnull)otherGestureRecognizer;
        [Export("gestureRecognizer:shouldRecognizeSimultaneouslyWithGestureRecognizer:")]
        bool GestureRecognizer(NSClickGestureRecognizer gestureRecognizer, NSClickGestureRecognizer otherGestureRecognizer);
    ...
    interface BubbleChartDataEntry
    {
        ...
        // -(instancetype _Nonnull)initWithX:(double)x y:(double)y size:(id)size icon:(NSImage * _Nullable)icon __attribute__((objc_designated_initializer));
        [Export("initWithX:y:size:icon:")]
        [DesignatedInitializer]
        IntPtr Constructor(double x, double y, nfloat size, [NullAllowed] NSImage icon);

        // -(instancetype _Nonnull)initWithX:(double)x y:(double)y size:(id)size icon:(NSImage * _Nullable)icon data:(id _Nullable)data __attribute__((objc_designated_initializer));
        [Export("initWithX:y:size:icon:data:")]
        [DesignatedInitializer]
        IntPtr Constructor(double x, double y, nfloat size, [NullAllowed] NSImage icon, [NullAllowed] NSObject data);
    ...
    interface CandleChartDataEntry
    {
        ...
        // -(instancetype _Nonnull)initWithX:(double)x shadowH:(double)shadowH shadowL:(double)shadowL open:(double)open close:(double)close icon:(NSImage * _Nullable)icon __attribute__((objc_designated_initializer));
        [Export("initWithX:shadowH:shadowL:open:close:icon:")]
        [DesignatedInitializer]
        IntPtr Constructor(double x, double shadowH, double shadowL, double open, double close, [NullAllowed] NSImage icon);

        // -(instancetype _Nonnull)initWithX:(double)x shadowH:(double)shadowH shadowL:(double)shadowL open:(double)open close:(double)close icon:(NSImage * _Nullable)icon data:(id _Nullable)data __attribute__((objc_designated_initializer));
        [Export("initWithX:shadowH:shadowL:open:close:icon:data:")]
        [DesignatedInitializer]
        IntPtr Constructor(double x, double shadowH, double shadowL, double open, double close, [NullAllowed] NSImage icon, [NullAllowed] NSObject data);
    ...
    interface InterfaceCandleChartDataSet : InterfaceLineScatterCandleRadarChartDataSet
    {
        ...
        // @required @property(nonatomic, strong) NSColor * _Nullable shadowColor;
        [Abstract]
        ...
        // @required @property(nonatomic, strong) NSColor * _Nullable neutralColor;
        [Abstract]
        [NullAllowed, Export("neutralColor", ArgumentSemantic.Strong)]
        NSColor NeutralColor { get; set; }

        // @required @property(nonatomic, strong) NSColor * _Nullable increasingColor;
        [Abstract]
        [NullAllowed, Export("increasingColor", ArgumentSemantic.Strong)]
        NSColor IncreasingColor { get; set; }

        // @required @property(nonatomic, strong) NSColor * _Nullable decreasingColor;
        [Abstract]
        [NullAllowed, Export("decreasingColor", ArgumentSemantic.Strong)]
        NSColor DecreasingColor { get; set; }
    ...
    {
        // +(NSArray<NSColor *> * _Nonnull)liberty;
        [Static]
        [Export("liberty")]
        NSColor[] Liberty { get; }

        // +(NSArray<NSColor *> * _Nonnull)joyful;
        [Static]
        [Export("joyful")]
        NSColor[] Joyful { get; }

        // +(NSArray<NSColor *> * _Nonnull)pastel;
        [Static]
        [Export("pastel")]
        NSColor[] Pastel { get; }

        // +(NSArray<NSColor *> * _Nonnull)colorful;
        [Static]
        [Export("colorful")]
        NSColor[] Colorful { get; }

        // +(NSArray<NSColor *> * _Nonnull)vordiplom;
        [Static]
        [Export("vordiplom")]
        NSColor[] Vordiplom { get; }

        // +(NSArray<NSColor *> * _Nonnull)material;
        [Static]
        [Export("material")]
        NSColor[] Material { get; }

        // +(NSColor * _Nonnull)colorFromString:(NSString * _Nonnull)colorString;
        [Static]
        [Export("colorFromString:")]
        NSColor ColorFromString(string colorString);
    }
    ...
    {
        //u-n-safe void DataSet(CGContextRef* context, IInterfaceScatterChartDataSet dataSet, ChartViewPortHandler viewPortHandler, CGPoint point, NSColor color);
    }
    ...
    {
        //u-n-safe void RenderShapeWithContext(CGContextRef* context, IInterfaceScatterChartDataSet dataSet, ChartViewPortHandler viewPortHandler, CGPoint point, NSColor color);
    }
    ...
    interface CombinedChartData
    {
        ...
        IInterfaceChartDataSet GetDataSetByHighlight(ChartHighlight highlight);
    }
    ...
    interface ChartFill
    {
        ...
        // -(instancetype _Nonnull)initWithColor:(NSColor * _Nonnull)color;
        ...
        // -(instancetype _Nonnull)initWithImage:(NSImage * _Nonnull)image tiled:(BOOL)tiled;
        [Export("initWithImage:tiled:")]
        IntPtr Constructor(NSImage image, bool tiled);

        //u-n-safe IntPtr Constructor(CGImageRef* CGImage);

        // -(instancetype _Nonnull)initWithImage:(NSImage * _Nonnull)image;
        ...
        // +(ChartFill * _Nonnull)fillWithColor:(NSColor * _Nonnull)color;
        [Static]
        [Export("fillWithColor:")]
        ChartFill FillWithColor(NSColor color);
        ...
        ChartFill FillWithCGImage(NSObject CGImage, NSObject tiled);

        // +(ChartFill * _Nonnull)fillWithImage:(NSImage * _Nonnull)image tiled:(BOOL)tiled;
        [Static]
        [Export("fillWithImage:tiled:")]
        ChartFill FillWithImage(NSImage image, bool tiled);

        //u-n-safe ChartFill FillWithCGImage(CGImageRef* CGImage);

        // +(ChartFill * _Nonnull)fillWithImage:(NSImage * _Nonnull)image;
        [Static]
        [Export("fillWithImage:")]
        ChartFill FillWithImage(NSImage image);

        // +(ChartFill * _Nonnull)fillWithCGLayer:(id)CGLayer __attribute__((warn_unused_result));
        [Static]
    ...
    {
        // @required @property(nonatomic, strong) NSColor * _Nonnull fillColor;
        [Abstract]
    ...
    interface InterfaceLineChartDataSet : InterfaceLineRadarChartDataSet
    {
        ...
        // @required @property(copy, nonatomic) NSArray<NSColor *> * _Nonnull circleColors;
        [Abstract]
        [Export("circleColors", ArgumentSemantic.Copy)]
        NSColor[] CircleColors { get; set; }

        // @required -(NSColor * _Nullable)getCircleColorAtIndex:(NSInteger)atIndex;
        [Abstract]
        [Export("getCircleColorAtIndex:")]
        [return: NullAllowed]
        NSColor GetCircleColorAtIndex(nint atIndex);

        // @required -(void)setCircleColor:(NSColor * _Nonnull)color;
        [Abstract]
        ...
        // @required @property(nonatomic, strong) NSColor * _Nullable circleHoleColor;
        [Abstract]
        [NullAllowed, Export("circleHoleColor", ArgumentSemantic.Strong)]
        NSColor CircleHoleColor { get; set; }
    ...
    interface InterfacePieChartDataSet : InterfaceChartDataSet
    {
        ...
        // @required @property(nonatomic, strong) NSColor * _Nullable valueLineColor;
        [Abstract]
        [NullAllowed, Export("valueLineColor", ArgumentSemantic.Strong)]
        NSColor ValueLineColor { get; set; }
        ...
        // @required @property(nonatomic, strong) NSFont * _Nullable entryLabelFont;
        [Abstract]
        [NullAllowed, Export("entryLabelFont", ArgumentSemantic.Strong)]
        NSFont EntryLabelFont { get; set; }

        // @required @property(nonatomic, strong) NSColor * _Nullable entryLabelColor;
        [Abstract]
        [NullAllowed, Export("entryLabelColor", ArgumentSemantic.Strong)]
        NSColor EntryLabelColor { get; set; }

        // @required @property(nonatomic, strong) NSColor * _Nullable highlightColor;
        [Abstract]
    ...
    interface InterfaceRadarChartDataSet : InterfaceLineRadarChartDataSet
    {
        ...
        // @required @property(nonatomic, strong) NSColor * _Nullable highlightCircleFillColor;
        [Abstract]
        [NullAllowed, Export("highlightCircleFillColor", ArgumentSemantic.Strong)]
        NSColor HighlightCircleFillColor { get; set; }

        // @required @property(nonatomic, strong) NSColor * _Nullable highlightCircleStrokeColor;
        [Abstract]
        [NullAllowed, Export("highlightCircleStrokeColor", ArgumentSemantic.Strong)]
        NSColor HighlightCircleStrokeColor { get; set; }
    ...
    interface InterfaceScatterChartDataSet : InterfaceLineScatterCandleRadarChartDataSet
    {
        ...
        // @required @property(readonly, nonatomic, strong) NSColor * _Nullable scatterShapeHoleColor;
        [Abstract]
        [NullAllowed, Export("scatterShapeHoleColor", ArgumentSemantic.Strong)]
        NSColor ScatterShapeHoleColor { get; }
    ...
    interface ChartLegend
    {
        ...
        // -(CGSize)getMaximumEntrySizeWithFont:(NSFont * _Nonnull)font;
        [Export("getMaximumEntrySizeWithFont:")]
        CGSize GetMaximumEntrySizeWithFont(NSFont font);
        ...
        void CalculateDimensionsWithLabelFont(NSFont labelFont, ChartViewPortHandler viewPortHandler);
    ...
    {
        // -(instancetype _Nonnull)initWithLabel:(NSString * _Nullable)label form:(enum ChartLegendForm)form formSize:(CGFloat)formSize formLineWidth:(CGFloat)formLineWidth formLineDashPhase:(CGFloat)formLineDashPhase formLineDashLengths:(NSArray<NSNumber *> * _Nullable)formLineDashLengths formColor:(NSColor * _Nullable)formColor __attribute__((objc_designated_initializer));
        [Export("initWithLabel:form:formSize:formLineWidth:formLineDashPhase:formLineDashLengths:formColor:")]
        [DesignatedInitializer]
        IntPtr Constructor([NullAllowed] string label, ChartLegendForm form, nfloat formSize, nfloat formLineWidth, nfloat formLineDashPhase, [NullAllowed] NSNumber[] formLineDashLengths, [NullAllowed] NSColor formColor);
    ...
    interface ChartLegendRenderer
    {
        ...
        // -(void)drawLabelWithContext:(CGContext)context x:(id)x y:(id)y label:(id)label font:(NSFont * _Nonnull)font textColor:(NSColor * _Nonnull)textColor;
        [Export("drawLabelWithContext:x:y:label:font:textColor:")]
        void DrawLabelWithContext(CGContext context, NSObject x, NSObject y, NSObject label, NSFont font, NSColor textColor);
    }
    ...
    interface LineChartDataSet : InterfaceLineChartDataSet
    {
        ...
        // @property(copy, nonatomic) NSArray<NSColor *> * _Nonnull circleColors;
        [Export("circleColors", ArgumentSemantic.Copy)]
        NSColor[] CircleColors { get; set; }
        ...
        [Export("getCircleColorAtIndex:")]
        [return: NullAllowed]
        NSColor GetCircleColorAtIndex(nint index);
    ...
    interface LineRadarChartRenderer
    {
        ...
        // -(void)drawFilledPathWithContext:(CGContext)context path:(id)path fillColor:(NSColor * _Nonnull)fillColor fillAlpha:(id)fillAlpha;
        [Export("drawFilledPathWithContext:path:fillColor:fillAlpha:")]
        void DrawFilledPathWithContext(CGContext context, NSObject path, NSColor fillColor, NSObject fillAlpha);
    }
    ...
    interface PieChartView
    {
        ...
        NSColor TransparentCircleColor { get; set; }
    ...
    interface ScatterChartDataSet : InterfaceScatterChartDataSet
    {
        ...
        [NullAllowed, Export("scatterShapeHoleColor", ArgumentSemantic.Strong)]
        NSColor ScatterShapeHoleColor { get; set; }
    ...
    {
        // -(void)renderShapeWithContext:(CGContext)context dataSet:(id<IScatterChartDataSet> _Nonnull)dataSet viewPortHandler:(ChartViewPortHandler * _Nonnull)viewPortHandler point:(CGPoint)point color:(NSColor * _Nonnull)color;
        [Export("renderShapeWithContext:dataSet:viewPortHandler:point:color:")]
        void RenderShapeWithContext(CGContext context, IInterfaceScatterChartDataSet dataSet, ChartViewPortHandler viewPortHandler, CGPoint point, NSColor color);
    }
    ...
    // @interface Charts_Swift_6204(NSPanGestureRecognizer)
    [Category]
    [BaseType(typeof(NSPanGestureRecognizer))]
    interface NSPanGestureRecognizer_Charts_Swift_6204
    {
    }

    // @interface Charts_Swift_6208(NSMagnificationGestureRecognizer)
    [Category]
    [BaseType(typeof(NSMagnificationGestureRecognizer))]
    interface NSMagnificationGestureRecognizer_Charts_Swift_6208
    {
    }

    // @interface Charts_Swift_6212(NSRotationGestureRecognizer)
    [Category]
    [BaseType(typeof(NSRotationGestureRecognizer))]
    interface NSRotationGestureRecognizer_Charts_Swift_6212
    {
    }

    // @interface Charts_Swift_6216(NSScreen)
    [Category]
    [BaseType(typeof(NSScreen))]
    interface NSScreen_Charts_Swift_6216
    {
    }

    // @interface Charts_Swift_6220(NSScrollView)
    [Category]
    [BaseType(typeof(NSScrollView))]
    interface NSScrollView_Charts_Swift_6220
    {
    }

    // @interface Charts_Swift_6224(NSClickGestureRecognizer)
    [Category]
    [BaseType(typeof(NSClickGestureRecognizer))]
    interface NSClickGestureRecognizer_Charts_Swift_6224
    {
    }

    // @interface Charts_Swift_6228(NSView)
    [Category]
    [BaseType(typeof(NSView))]
    interface NSView_Charts_Swift_6228
    {
    }
